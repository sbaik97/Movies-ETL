...
* Write a function that extract and transform the Wikipedia data so you can merge it with the Kaggle metadata.
* Write a function that extract and transform the Kaggle metadata and MovieLens rating data, then convert the transformed data into separate DataFrames.
* Write a function that add the movies_df DataFrame and MovieLens rating CSV data to a SQL database
